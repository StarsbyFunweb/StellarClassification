...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-200 font-sans flex flex-col overflow-hidden">
      ...
      {/* Main Content */}
      <main className="flex-1 flex flex-col lg:flex-row mt-16 lg:mt-20 h-[calc(100vh-4rem)] lg:h-[calc(100vh-5rem)]">
        
        {/* Left: Star Canvas (60%) */}
        <div className="w-full lg:w-[60%] h-[50vh] lg:h-full relative bg-black">
        ...
        <div className="w-full lg:w-[40%] h-full overflow-y-auto custom-scrollbar bg-[#050914] relative border-l border-slate-800 p-6 lg:p-8 pb-24 lg:pb-8">
